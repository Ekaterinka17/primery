...
2. Двое исполнителей работают в разных ветках и вносят разные изменения в одну строку одного файла.

3. Двое исполнителей работают в одной ветке и вносят разные изменения в одну строку одного файла. 
