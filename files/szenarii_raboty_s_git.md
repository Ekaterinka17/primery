...
1. Склонируйте репозиторий с помощью команды `git clone` (все необходимые действия см. в подразделе [Клонирование удаленного репозитория](#klonirovanie_udalennogo_repozitoriya)).
