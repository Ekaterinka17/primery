...
2. Откроется cтраница слияния веток. 

<p align="center">
  <img src="/images/merge_git.png" />
</p>

3. Проверяем отсутствие конфликтов (см. подраздел **Конфликты при слиянии веток**). Если конфликтов нет, нажимаем кнопку **Merge pull request**
4. Подтверждаем слияние веток с помощью кнопки **Confirm merdge**.
5. Откроется страница с уведомлением о слиянии веток. При необходимости можно заполнить блок с комментарием в нижней части страницы и нажать кнопку **Comment**.
