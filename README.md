...
Для создания новой ветки от текущей локальной ветки выбираем команду *Create new branch* и вводим наименование ветки (аналог команды `git checkout -b <имя ветки>`). 

Для создания ветки от другой ветки выбираем команду *Create new branch from* и вводим наименование ветки (аналог команды `git branch <имя ветки>`). 
