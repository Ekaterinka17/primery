...
В рамках настоящей ринструкции предполагается работа с Git толька на ОС Windows.
...
Рассмотрим панели и инсрументы VS Code для работы с ветками и коммитами Git.
...
2. Для работы с коммитами в VS Code предусмотрен раздел **Source Control** (1), после открытия которого отображаются вкладки *Source Control* (2) и *Source Control Graph* (3).

<p align="center">
  <img src="/images/commit_vs.png" />
</p>

- На вкладке *Source Control* расположены элементы для написания и отправки коммита в удаленный репозиторий.
