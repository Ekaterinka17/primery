...
Откроем на ПК папку **Git_proect** и увидим в ней вторую склонированную папку **primery**. Вторая папка — это наименование проекта/удаленного репозитория на GitHub, т.к. в ней находится Git-репозиторий **.git**. Перейдем в эту папку с помощью команды:
