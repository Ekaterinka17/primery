...
8. `git branch -d <vetka>` — удаление ветки с имененем *vetka*.
...
14. `git pull` — загрузка содержимого из удаленного репозитория и обновление локального репозитория этим содержимым.
